      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="order-2 md:order-1">
          <img
            ...
            alt="Yarrow Holistic Beauty interior"
        ...
        <div className="order-1 md:order-2 animate-slideInRight">
          ...
          <h2 className="text-3xl md:text-4xl font-display font-semibold text-gray-800 mb-6">
            Your Holistic Beauty Sanctuary
          </h2>
          
          <p className="text-gray-600 mb-6 leading-relaxed">
            Welcome to Yarrow Holistic Beauty, Charleston's premier non-toxic salon suite. We're committed to providing exceptional hair services with organic, sustainable products that nurture your hair while respecting our planet.
          </p>
          
          <p className="text-gray-600 mb-6 leading-relaxed">
            Our philosophy embraces holistic beauty—recognizing that true beauty stems from health, sustainability, and mindful practices. Every service at Yarrow is designed with your wellbeing and environmental impact in consideration.
          </p>
          
          <div className="flex items-center mb-8 text-yarrow-stone">
            <MapPin className="h-5 w-5 mr-2 text-yarrow-sage" />
            <address className="not-italic">
              1334 Ashley River Road, Charleston, SC 29407
            </address>
          </div>
